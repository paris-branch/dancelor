...
%% of “specificity” (eg. Bb instruments, or bass clef).
\makeatletter
\def\@specificity{}
...
\newcommand\tune[3]{%
  ...
  \addtunetotoc{#1}{#2}%
  \vbox{
    \makebox[\linewidth]{#1\hfill{}#2}\\[2mm]%
    ...
    \hspace*{-.05\linewidth}\makebox[1.05\linewidth]{\includegraphics[width=1.05\linewidth]{#3}}%
  }%
}
