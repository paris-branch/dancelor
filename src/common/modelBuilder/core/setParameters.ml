...
let make ?forced_pages ?show_deviser ?show_order ?display_name ?display_conceptor ?display_kind ?every_version () =
  make ~forced_pages ~show_deviser ~show_order ~display_name ~display_conceptor ~display_kind ?every_version ()
