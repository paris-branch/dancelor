module type S = sig
  ...
  val dances : (Model_builder.Core.Dance.t, Core.Dance.t) Formula_entry.t Formula_list.t -> predicate
  val dances' : (Model_builder.Core.Dance.t, Core.Dance.t) Formula_entry.t Formula_list.t -> t
