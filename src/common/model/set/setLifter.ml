...
= struct
  ...
  module Filter = struct
    ...
    let nullary_text_predicates = [
      "reel",       (kind KindFilter.(Dance.base Kind.Base.(Filter.is Reel)));       (* alias for kind:reel       FIXNE: make this clearer *)
      "jig",        (kind KindFilter.(Dance.base Kind.Base.(Filter.is Jig)));        (* alias for kind:jig        FIXNE: make this clearer *)
      "strathspey", (kind KindFilter.(Dance.base Kind.Base.(Filter.is Strathspey))); (* alias for kind:strathspey FIXNE: make this clearer *)
      "waltz",      (kind KindFilter.(Dance.base Kind.Base.(Filter.is Waltz)));      (* alias for kind:waltz      FIXNE: make this clearer *)
    ]
