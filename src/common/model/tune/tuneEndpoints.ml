...
type (_, _, _) t =
  ...
  | Save : ((Status.t option -> Datetime.t -> Datetime.t -> TuneCore.t -> 'w), 'w, TuneCore.t Entry.t) t
...
let route : type a w r. (a, w, r) t -> (a, w, r) route = function
  ...
  | Save -> literal "save" @@ query_opt "status" (module Status) @@ query "modified-at" (module Datetime) @@ query "created-at" (module Datetime) @@ query "tune" (module TuneCore) @@ return (module Entry.J(TuneCore))
