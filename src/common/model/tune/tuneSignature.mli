...
val composer : t -> PersonCore.t option Lwt.t
...
module Filter : sig
  ...
  val composer : PersonCore.Filter.t -> predicate
  val composer' : PersonCore.Filter.t -> t

  val composerIs : PersonCore.t -> predicate
  val composerIs' : PersonCore.t -> t
