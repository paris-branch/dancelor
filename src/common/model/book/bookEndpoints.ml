...
type (_, _, _) t =
  ...
  | Save : ((BookCore.t -> 'w), 'w, BookCore.t Entry.t) t
  | Update : ((BookCore.t Slug.t -> BookCore.t -> 'w), 'w, unit) t
...
let route : type a w r. (a, w, r) t -> (a, w, r) route = function
  ...
  | Save -> literal "save" @@ query "book" (module BookCore) @@ return (module Entry.J(BookCore))
  | Update -> literal "update" @@ variable (module SSlug(BookCore)) @@ query "book" (module BookCore) @@ return (module JUnit)
