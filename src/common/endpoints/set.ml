...
| BuildPdf : ((Set.t Entry.Id.t -> SetParameters.t -> RenderingParameters.t -> 'w), 'w, JobId.t) t
...
let route : type a w r. (a, w, r) t -> (a, w, r) route =
  ...
  function
    ...
    (* Files related to a set *)
    | BuildPdf -> literal "build-pdf" @@ variable (module Entry.Id.S(Set)) @@ query "parameters" (module SetParameters) @@ query "rendering-parameters" (module RenderingParameters) @@ post (module JobId)
