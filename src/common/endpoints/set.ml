...
| BuildPdf : ((Set.t Entry.Id.t -> Set_parameters.t -> Rendering_parameters.t -> 'w), 'w, Job_id.t Job.registration_response) t
...
let route : type a w r. (a, w, r) t -> (a, w, r) route =
  ...
  function
    ...
    (* Files related to a set *)
    | BuildPdf -> literal "build-pdf" @@ variable (module Entry.Id.S(Set)) @@ query "parameters" (module Set_parameters) @@ query "rendering-parameters" (module Rendering_parameters) @@ post (module Job.Registration_response(Job_id))
