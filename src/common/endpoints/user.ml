...
type (_, _, _) t =
  ...
  | ResetPassword : ((User.t Slug.t -> string -> string -> 'w), 'w, unit) t
...
let route : type a w r. (a, w, r) t -> (a, w, r) route =
  ...
  function
    ...
    | SignIn -> literal "sign-in" @@ body "username" (module JSlug(User)) @@ body "password" (module JString) @@ body "remember-me" (module JBool) @@ post (module JOption(Entry.J(User)))
