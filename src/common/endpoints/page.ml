...
let route : type a w r. (a, w, r) t -> (a, w, r) route =
  ...
  function
    ...
    | Book -> literal "book" @@ query_json_opt "context" (module Context) @@ variable (module Entry.Id.S(Core.Book)) @@ void ()
    | Book_add -> literal "book" @@ literal "add" @@ void ()
    | Book_edit -> literal "book" @@ literal "edit" @@ variable (module Entry.Id.S(Core.Book)) @@ void ()
    | Dance -> literal "dance" @@ query_json_opt "context" (module Context) @@ variable (module Entry.Id.S(Core.Dance)) @@ void ()
    | Dance_add -> literal "dance" @@ literal "add" @@ void ()
    | Dance_edit -> literal "dance" @@ literal "edit" @@ variable (module Entry.Id.S(Core.Dance)) @@ void ()
    | Person -> literal "person" @@ query_json_opt "context" (module Context) @@ variable (module Entry.Id.S(Core.Person)) @@ void ()
    ...
    | Set -> literal "set" @@ query_json_opt "context" (module Context) @@ variable (module Entry.Id.S(Core.Set)) @@ void ()
    | Set_add -> literal "set" @@ literal "add" @@ void ()
    | Set_edit -> literal "set" @@ literal "edit" @@ variable (module Entry.Id.S(Core.Set)) @@ void ()
    | Source -> literal "source" @@ query_json_opt "context" (module Context) @@ variable (module Entry.Id.S(Core.Source)) @@ void ()
    ...
    | Tune -> literal "tune" @@ query_json_opt "context" (module Context) @@ variable (module Entry.Id.S(Core.Tune)) @@ void ()
    | Tune_add -> literal "tune" @@ literal "add" @@ void ()
    | Tune_edit -> literal "tune" @@ literal "edit" @@ variable (module Entry.Id.S(Core.Tune)) @@ void ()
    | Version -> literal "version" @@ query_json_opt "context" (module Context) @@ variable (module Entry.Id.S(Core.Version)) @@ void ()
    | Version_add -> query_json_opt "tune" (module Entry.Id.J(Core.Tune)) @@ literal "version" @@ literal "add" @@ void ()
    ...
    | User_password_reset -> literal "user" @@ literal "reset-password" @@ query_json "username" (module Username) @@ query_json "token" (module Core.User.Password_reset_token_clear) @@ void ()
