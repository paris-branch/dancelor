...
| BuildPdf : ((Book.t Entry.Id.t -> Book_parameters.t -> Rendering_parameters.t -> 'w), 'w, Job_id.t Job.registration_response) t
...
let route : type a w r. (a, w, r) t -> (a, w, r) route =
  ...
  function
    ...
    | BuildPdf -> literal "build-pdf" @@ variable (module Entry.Id.S(Book)) @@ query "parameters" (module Book_parameters) @@ query "rendering-parameters" (module Rendering_parameters) @@ post (module Job.Registration_response(Job_id))
