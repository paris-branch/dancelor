...
| Search : ((Slice.t -> (Version.t, Filter.Version.t) Formula_entry.t -> 'w), 'w, (int * Version.entry list)) t
...
let route : type a w r. (a, w, r) t -> (a, w, r) route =
  ...
  function
    ...
    | Search -> query "slice" (module Slice) @@ query "filter" (module Formula_entry.J(Version)(Filter.Version)) @@ get (module JPair(JInt)(JList(Entry.JPublic(Version_no_lilypond))))
    (* Actions on a specific version *)
