...
| Search : ((Slice.t -> (Tune.t, Filter.Tune.t) Formula_entry.public -> 'w), 'w, (int * Tune.entry list)) t
...
let route : type a w r. (a, w, r) t -> (a, w, r) route =
  ...
  function
    ...
    | Search -> query "slice" (module Slice) @@ query "filter" (module Formula_entry.JPublic(Tune)(Filter.Tune)) @@ get (module JPair(JInt)(JList(Entry.JPublic(Tune))))
    (* Actions on a specific tune *)
