...
let map_table ~header list fun_ =
  table
    ~classes: ["separated-table"; "visible"]
    [
...
let books books =
  map_table ~header: ["Book"; "Date"] books
  @@ fun book ->
    let href_lwt =
...
let sets sets =
  map_table ~header: ["Name"; "Deviser"; "Kind"] sets
  @@ fun set ->
    let href_lwt =
...
let dances dances =
  map_table ~header: ["Name"; "Deviser"; "Kind"] dances
  @@ fun dance ->
    let href_lwt =
...
let tunes tunes =
  map_table ~header: ["Name"; "Kind"; "Author"] tunes
  @@ fun tune ->
    let href_lwt =
