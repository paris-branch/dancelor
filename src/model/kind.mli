...
val base_to_yaml : base -> Yaml.value
val base_of_yaml : Yaml.value -> base
...
val tune_to_yaml : tune -> Yaml.value
val tune_of_yaml : Yaml.value -> tune
...
val dance_to_yaml : dance -> Yaml.value
val dance_of_yaml : Yaml.value -> dance
