...
let migrations : migration list = [
  ...
  make_ddl "m046_2026_05_add_unique_constraint_version_sources_version_id_source_id" Migrations_sql.m046_2026_05_add_unique_constraint_version_sources_version_id_source_id;
