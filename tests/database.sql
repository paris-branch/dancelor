...
INSERT INTO "dancelor"."book" ("id", "yaml") VALUES ('0fi3-1iot-6tbq', 'value:
...
INSERT INTO "dancelor"."dance" ("id", "yaml") VALUES ('l02q-i1j0-qpoi', 'value:
  kind: 8 x 32 R
  devisers:
    - 8h62-3eis-xfem
  names:
...
INSERT INTO "dancelor"."person" ("id", "yaml") VALUES ('4plf-srss-ihav', 'value:
  name: Davey Arthur
...
access:
  - Public
');
INSERT INTO "dancelor"."person" ("id", "yaml") VALUES ('8h62-3eis-xfem', 'value:
  name: Mervyn C Short
  scddb-id: 347
meta:
...
access:
  - Public
');
INSERT INTO "dancelor"."person" ("id", "yaml") VALUES ('uwoe-u6ij-ikgp', 'value:
...
INSERT INTO "dancelor"."set" ("id", "yaml") VALUES ('ului-yd9x-o35w', 'value:
  name: Tam Lin Thrice
  conceptors:
    - uwoe-u6ij-ikgp
  kind: 3x32R
...
access:
  ...
  visibility:
    - Everyone
');
INSERT INTO "dancelor"."set" ("id", "yaml") VALUES ('wrwk-cz9g-g3wi', 'value:
  name: A Private Set
  conceptors:
    - uwoe-u6ij-ikgp
  kind: 3x32R
...
INSERT INTO "dancelor"."source" ("id", "yaml", "cover") VALUES ('2f8s-90v8-33do', 'value:
...
INSERT INTO "dancelor"."tune" ("id", "yaml") VALUES ('qdod-ad7l-8gr2', 'value:
  names:
    - Tam Lin
  kind: R
  composers:
...
INSERT INTO "dancelor"."user" ("id", "yaml") VALUES ('lt3h-edgt-ac97', 'value:
...
INSERT INTO "dancelor"."version" ("id", "yaml") VALUES ('xzzb-wasm-babe', 'value:
  tune: qdod-ad7l-8gr2
  key: Dm
