...
class TestContextLinks():
  ...
  def test_fromExplorerSearch(self):
    ...
    utils.wait_and_send_keys(self.driver, By.XPATH, "//div[@class = 'container-md']//input", "tam")
    # Wait for search results to appear before clicking
    utils.wait_and_click(self.driver, By.XPATH, "//*[contains(text(), 'Tam Lin Thrice')]")
    self.wait.until(EC.url_to_be("http://localhost:8080/set/ului-yd9x-o35w?context=%5B%22InSearch%22%2C%22tam%22%5D"))
  ...
  def test_fromSet(self):
    ...
    utils.wait_and_click(self.driver, By.XPATH, "(//a[text() = 'Tam Lin'])[2]")
  ...
  def test_fromBook(self):
    ...
    # Wait for the table content to load (not placeholder) before clicking
    utils.wait_and_click(self.driver, By.XPATH, "//tr[2]/td")
  ...
  def test_sideArrowGoesToNeighbour(self):
    ...
    utils.wait_and_click(self.driver, By.XPATH, "//a[contains(@class, 'btn')]//i[contains(@class, 'bi-arrow-left')]")
  ...
  def test_bannerUndoGoesToContext(self):
    ...
    self.driver.get("http://localhost:8080/set/ului-yd9x-o35w?context=%5B%22InSearch%22%2C%22tam%22%5D")
    utils.wait_and_click(self.driver, By.XPATH, "//a[contains(@class, 'btn')]//i[contains(@class, 'bi-arrow-counterclockwise')]")
  ...
  def test_bannerCloseRemovesContext(self):
    ...
    self.driver.get("http://localhost:8080/set/ului-yd9x-o35w?context=%5B%22InSearch%22%2C%22tam%22%5D")
    utils.wait_and_click(self.driver, By.XPATH, "//a[contains(@class, 'btn')]//i[contains(@class, 'bi-eraser')]")
