...
class TestContextLinks():
  ...
  def test_fromExplorerSearch(self):
    ...
    self.wait.until(EC.url_to_be("http://localhost:8080/set/view/ului-yd9x-o35w?context=%5B%22In_search%22%2C%22tam%22%5D"))
  ...
  def test_fromSet(self):
    ...
    self.wait.until(EC.url_to_be("http://localhost:8080/version/view/xzzb-wasm-babe?context=%5B%22In_set%22%2C%22ului-yd9x-o35w%22%2C1%5D"))
  ...
  def test_fromBook(self):
    ...
    self.wait.until(EC.url_to_be("http://localhost:8080/set/view/ului-yd9x-o35w?context=%5B%22In_book%22%2C%220fi3-1iot-6tbq%22%2C1%5D"))
  ...
  def test_sideArrowGoesToNeighbour(self):
    ...
    self.driver.get("http://localhost:8080/set/view/ului-yd9x-o35w?context=%5B%22In_search%22%2C%22tam%22%5D")
    self.driver.find_element(By.XPATH, "//a[contains(@class, 'btn')]//i[contains(@class, 'bi-arrow-left')]").click()
    self.wait.until(EC.url_to_be("http://localhost:8080/version/view/xzzb-wasm-babe?context=%5B%22In_search%22%2C%22tam%22%5D"))
