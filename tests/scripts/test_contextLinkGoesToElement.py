...
class TestContextLinkGoesToElement():
  ...
  def test_contextLinkGoesToElementWithClick(self):
    ...
    self.wait.until(EC.text_to_be_present_in_element((By.CSS_SELECTOR, ".title:nth-child(1)"), "The Tam Lin Book"))
    self.wait.until(EC.title_is("The Tam Lin Book | Book | Dancelor"))
